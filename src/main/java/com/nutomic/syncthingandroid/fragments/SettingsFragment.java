...
public class SettingsFragment extends PreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object o) {
        ...
        if (preference.getKey().equals(STTRACE)) {
            isValid = ((String) o).matches("[a-z, ]*");
            message = R.string.toast_invalid_sttrace;
        } else if (preference.getKey().equals(GUI_USER)) {
            String s = (String) o;
            isValid = !s.contains(":") && !s.contains("'");
            message = R.string.toast_invalid_username;
        } else if (preference.getKey().equals(GUI_PASSWORD)) {
            String s = (String) o;
            isValid = !s.contains(":") && !s.contains("'");
            message = R.string.toast_invalid_password;
        }
        if (!isValid) {
        ...
        // Set the preference value as summary (except for password).
        if (preference instanceof EditTextPreference &&
                !preference.getKey().equals(GUI_PASSWORD)) {
